<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $date1=$_POST['date1'];
        $sql="INSERT INTO `projectdetails` (`ptitle`, `phead`, `budget`, `doc`, `pdetail`, `deliverable1`, `date1`) VALUES ('$pname', '$phead', '$budget', '$doc', '$detail', '$deliverable1', '$date1');";
        try
        {
        ...
        {
            echo "<h1 style='color:red'>This Project might exist Please Check the Dashboard</h2>";
        }
    }
?>
<!DOCTYPE html>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="flex-column">
            ...
            <div class="container-fluid">
                <!--Page Heading-->
                <div class="viewhead">
                    <h1 class="h3 dastxt">Your Project Details</h1>
                </div>
                <!--Content Row-->
                ...
                <form id="contactForm" method="post">
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="projectTitle" type="text" name="title" required/>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Project Head</label>
                        <select class="form-control" name="phead" id="phead">
                            <option>NAREN</option>
                            <option>ADHARSH</option>
                            <option>SASHANK</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="budget">Budget</label>
                        <input class="form-control" id="budget" type="text" name="budget" required/>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="dateOfCompletion">Completion Date</label>
                        <input class="form-control" id="dateOfCompletion" type="date" name="doc" required/>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="details">Details</label>
                        <input class="form-control" id="details" type="text" name="details" required/>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="deliverable1">Deliverable 1</label>
                        <input class="form-control" id="deliverable1" type="text" name="deliverable1" required/>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="data1">Data 1</label>
                        <input class="form-control" id="data1" type="date" name="date1" required/>
                    </div>
                    <div class="d-grid">
                        <input class="button btn-primary" id="submitButton" name="submit" type="submit" value="Submit">
                    </div>
                </form>
                </div>
                <!--/.container-fluid-->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a class="button btn-secondary" href="projectadd.php">Cancel</a>
